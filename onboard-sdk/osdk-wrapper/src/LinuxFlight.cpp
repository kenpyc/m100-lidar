...
//new method implemented by Adam Wathieu, and Brian Cruz
int Stop(CoreAPI* api, Flight* flight)
{
  //Check if in air
  if (UserConfig::targetVersion != versionA3_32)
  {
  ...
  int positionControlStatus = moveByPositionOffset(api, flight, 0, 0, 0, 0);
